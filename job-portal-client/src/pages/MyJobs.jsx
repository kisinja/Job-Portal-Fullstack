...
const MyJobs = () => {
  ...
  const BASE_URL = `${import.meta.env.VITE_BACKEND_URL}/jobs/myJobs/${userId}`;
    ...
    <div className="container max-w-screen-2xl mx-auto xl:px-24 px-4">
      <div className="my-jobs-container">
        ...
        <div className="search-box p-2 text-center mb-2 relative">
          ...
          />
          <div
            className="border-l text-gray-500 font-semibold py-3.5 px-3 rounded-sm mb-4 w-fit absolute top-2 right-2 hover:bg-blue hover:text-white"
            onClick={handleClick}
          >
            <FiSearch
                  ...
                  jobs.map((job, index) => (
                    <tr key={job._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 flex items-center gap-2">
                        ...
                        <button
                          className="py-2 px-4 rounded-sm shadow-sm"
