    ...
    return (
        <div className="w-full bg-white p-4 rounded shadow flex flex-col gap-3">
            <h3 className="text-lg font-bold text-primary flex items-center gap-2">
                <SiMinutemailer className="text-[#3575E2] text-xl" />
                Email me for jobs
            </h3>
            ...
            <form action="" className="flex flex-col gap-3">
                ...
                <button type="submit" className="bg-[#3575E2] text-white py-2 px-5 rounded-md focus:bg-orange-50 focus:text-black focus:ring-4 focus:ring-[#3575E2] focus:outline-none">Subscribe</button>
            </form>
        </div>
    )
}
