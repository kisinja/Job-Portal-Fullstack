...
export const registerUser = async (req, res) => {
  const { username, email, password, role: userRole } = req.body; // Renamed to userRole
  try {
    // check if user exists using the signUp method from the User model
    const user = await User.signUp(username, email, password, userRole); // Use userRole here
